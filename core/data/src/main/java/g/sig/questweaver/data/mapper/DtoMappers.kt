...
fun Dto.toDomain(): DomainEntity =
    when (this) {
        ...
        is RequestGameStateDto -> RequestGameState
        is TransformationDataDto -> toDomain()
...
fun GameDto.toDomain() =
    Game(
        ...
        title,
        description,
        AndroidUri.EMPTY.toDomain(),
        players,
        maxPlayers,
        dmId,
        hostDeviceId.takeIf { it.isNotEmpty() },
    )
...
fun AnnotationDto.DrawingDto.toDomain() =
    Annotation.Drawing(
        id = id,
        createdBy = createdBy,
        ...
        transformationData = transformationDataDto.toDomain(),
    )

fun AnnotationDto.TextDto.toDomain() =
    Annotation.Text(
        id = id,
        createdBy = createdBy,
        text = text,
...
fun AnnotationDto.ImageDto.toDomain() =
    Annotation.Image(
...
fun TransformationDataDto.toDomain() =
    TransformationData(
        scale = scale,
