package g.sig.questweaver.permissions.navigation
...
import g.sig.questweaver.permissions.PermissionViewModel
import g.sig.questweaver.permissions.screens.PermissionScreen
...
fun NavGraphBuilder.permissionGraph(
    ...
    composable(PermissionRoute.path) {
        ...
        val permissionState =
            rememberMultiplePermissionsState(permissions = viewModel.permissions) {
